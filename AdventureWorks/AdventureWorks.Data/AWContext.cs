    ...
    public partial class AWContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Email>(entity =>
            {
                ...
                entity.Property(e => e.ModifedDate).HasColumnType("datetime2(0)");
                ...
                entity.HasOne(d => d.Person)
                    .WithMany(p => p.Email)
                    .HasForeignKey(d => d.PersonId)
                    .HasConstraintName("FK_Email_PersonID");
            });
            ...
            modelBuilder.Entity<Person1>(entity =>
            {
                ...
                entity.Property(e => e.ModifedDate).HasComputedColumnSql("(sysutcdatetime())");

                entity.Property(e => e.PhoneId).HasColumnName("PhoneID");

                entity.HasOne(d => d.Phone)
                    .WithMany(p => p.Person1)
                    .HasForeignKey(d => d.PhoneId)
                    .HasConstraintName("FK__Person__PhoneID__5FD33367");
            });
            ...
            modelBuilder.Entity<PizzaCheese>(entity =>
            {
                entity.ToTable("PizzaCheese", "PizzaStore");

                entity.Property(e => e.PizzaCheeseId).HasColumnName("PizzaCheeseID");
                ...
                entity.HasOne(d => d.Cheese)
                    .WithMany(p => p.PizzaCheese)
                    .HasForeignKey(d => d.CheeseId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PizzaCheese_Cheese");

                entity.HasOne(d => d.Pizza)
                    .WithMany(p => p.PizzaCheese)
                    .HasForeignKey(d => d.PizzaId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PizzaCheese_Pizza");
            });
            ...
            modelBuilder.Entity<PizzaTopping>(entity =>
            {
                ...
                entity.HasOne(d => d.Pizza)
                    ...
                    .HasForeignKey(d => d.PizzaId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PizzaTopping_Pizza");

                entity.HasOne(d => d.Topping)
                    .WithMany(p => p.PizzaTopping)
                    .HasForeignKey(d => d.ToppingId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PizzaTopping_Topping");
            });
