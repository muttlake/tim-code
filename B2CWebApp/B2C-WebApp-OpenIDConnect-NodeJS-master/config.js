...
exports.creds = {
  ...
  // feature.
  identityMetadata: 'https://login.microsoftonline.com/muttlake.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
  // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'

  // Required, the client ID of your app in AAD  
  clientID: '27324460-498e-4dc8-8458-7410d654d1ca',
  ...
  clientSecret: '&W!1;k>_K3A{;{dQF1Q|0QN9',
...
exports.destroySessionUrl = 
  'https://login.microsoftonline.com/muttlake.onmicrosoft.com/oauth2/v2.0/logout' +
  '?p=signin' +
